...
#define PCT_TEM_H
    ...
    template<typename B, typename D, typename F> void combine_x_slices( B, D, F, const int, const int, const int, const int, bool );
...
extern std::string __path;
extern std::string __fname;
extern std::string __filepath;
extern std::string __outstring;
extern std::stringstream  __line_sstream;
extern std::stringstream  __strcat_sstream;
...
extern void pkill(unsigned int&, unsigned int&, bool);
